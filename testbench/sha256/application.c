/* Original SHA-2 implementation copyright Alain Mosnier (https://github.com/amosnier/sha-2)
 * Used here under license. See file LICENSE for more details.
 *
 */
